...
function Cards() {
  return (
    <>
      ...
      <i class="fa-solid fa-wifi" id='icon12'></i>
      ...
      <i class="fa-solid fa-users" id='icon12'></i>
      <h1 className='txt12'>Social Games</h1>
      ...
      <i class="fa-solid fa-cart-shopping" id='icon12'></i>
